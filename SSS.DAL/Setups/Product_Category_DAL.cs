...
{
    public class Product_Category_DAL : DBInteractionBase
    {
        private Product_Category_Property objProductCategory;
        //private ErrorTracer objErrorTrace;

        public Product_Category_DAL(Product_Category_Property objProduct_Category)
        {
            objProductCategory = objProduct_Category;
        }
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"Update [dbo].[Product_Category] SET
            [Category] = @Category
            ,[HSCodeCat]=@HSCodeCat
...
where [idx]=@idx
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select Concat(us.firstName,'',us.lastName) as userName,pc.* from Product_Category pc
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update Product_Category SET visible=0 where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
