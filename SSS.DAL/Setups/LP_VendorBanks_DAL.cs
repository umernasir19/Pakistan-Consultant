...
namespace SSS.DAL.Setups
{
    public class LP_VendorBanks_DAL : DBInteractionBase
    {
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_BankInsert]";
            ...
            try
            {
                ...
                //cmdToExecute.Parameters.Add(new SqlParameter("@bankname", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBankProperty.bankName));
                //cmdToExecute.Parameters.Add(new SqlParameter("@creationDate", SqlDbType.DateTime, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBankProperty.creationDate));
                //cmdToExecute.Parameters.Add(new SqlParameter("@userid", SqlDbType.Int, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBankProperty.createdByUserIdx));
                //cmdToExecute.Parameters.Add(new SqlParameter("@visible", SqlDbType.Bit, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBankProperty.visible));
                //cmdToExecute.Parameters.Add(new SqlParameter("@uid", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.UserId));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetALLBanks]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelectBankById]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                //cmdToExecute.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBankProperty.idx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_BankUpdate]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                //cmdToExecute.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBankProperty.idx));
                //cmdToExecute.Parameters.Add(new SqlParameter("@bankName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBankProperty.bankName));
                //cmdToExecute.Parameters.Add(new SqlParameter("@status", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Status));
                //cmdToExecute.Parameters.Add(new SqlParameter("@isactive", SqlDbType.Bit, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.ISActive));
                //cmdToExecute.Parameters.Add(new SqlParameter("@datecreated", SqlDbType.DateTime, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.CreatedDate));
                //cmdToExecute.Parameters.Add(new SqlParameter("@uid", SqlDbType.Int, 200, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.UserId));
